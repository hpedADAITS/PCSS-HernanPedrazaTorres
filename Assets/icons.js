// Definiciones SVG de iconos (incrustados como strings para no requerir HTTP requests)
const icons = {
  // Icono de teléfono: diagrama de auricular
  ...
  // Icono de ubicación: marcador de mapa con círculo
...
// Función para obtener SVG por nombre (fallback: string vacío si no existe)
